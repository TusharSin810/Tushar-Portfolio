    ...
    <div className='h-max bg-[#53565A] pb-16'>
        ...
        <div class="grid grid-cols-3 px-10 gap-7 gap-x-8 sm:grid-cols-6 sm:px-80 sm:gap-5">
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">HTML</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">CSS</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">JavaScript</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">React Js</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Node Js</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Express</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Postgre SQL</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Tailwind CSS</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">C++</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Python</p>
                </div>
            </div>    
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">GitHub</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Postman</p>
                </div>
            </div>  
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Solidity</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Machine Learning</p>
                </div>
            </div>
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Data Science</p>
                </div>
            </div>               
            ...
            <div class="group w-fit">
                ...
                <p class="text-black select-none text-[10px] sm:text-sm font-medium text-center hidden group-hover:block">Git</p>
                </div>
            </div> 

...
function About() {
  return (
    <div>
        <div className='h-max bg-white pb-8'>
            <h2 className='text-2xl font-extrabold flex w-screen justify-center p-5 pt-10'>About Me</h2>
            <div className='flex flex-col items-center'>
                <p className='p-6 flex sm:hidden text-center'>
                    I’m an Electronics and Communication Engineering student at JIIT, Noida, with a passion for full-stack development. I build scalable, user-centric web applications and am currently expanding my skills in Web3, Data Science, and Machine Learning.
                    <br/>
                    I’m also pursuing a distance BSc in Data Science and Programming from IIT Madras.
                </p>
                <p className='hidden p-4 sm:flex sm:w-3/5 text-center'>
                ...
                <p className='px-6 pb-2 text-center'>"Always exploring new tech stacks to push boundaries and innovate."</p>
            </div>
        </div>
    </div>
  )

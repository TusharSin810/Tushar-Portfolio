      ...
      content: (
        <div>
          <p
            ...
            I was the Head Of Operations of the Robotics Club at my college for one year, CICR, where I contributed to various technical projects. Additionally, I served as a core team member of the JODC (Open Source Developers Club), collaborating on open-source projects and mentoring peers.
          </p>
          <div className="mb-8">
            <div
